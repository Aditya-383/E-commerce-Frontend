...
export const findProducts=(reqData)=>async(dispatch)=>{
    ...
    try {
        console.log("yes");
        const {data}=await api.get(`/api/products?color=${color}&size=${sizes}&minPrice=${minPrice}&maxPrice=${maxPrice}&minDiscount=${minDiscount}&category=${category}&stock=${stock}&stock=${sort}
        &pageNumber=${pageNumber}&pageSize=${pageSize}`);
    console.log("aditya-product data",data);
