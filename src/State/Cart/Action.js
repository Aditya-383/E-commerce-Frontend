...
import {
    ...
    ADD_ITEM_TO_CART_SUCCESS, GET_CART_FAILURE, GET_CART_REQUEST, GET_CART_SUCCESS, REMOVE_CART_ITEM_FAILURE,
...
export const removeCartItemRequest = (reqData) =>async (dispatch) => {
