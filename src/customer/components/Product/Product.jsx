/*
 this the product of the ecommerce and has fillter the products
*/
    ...
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-20">
          ...
          {/* 
          *******this code could be applicable after fix the bug product.service.getallproduct.01
          
          {product.products && product.products?.contents.map((item) => <ProductCard Product={item} />)}
          */}
          ...
          <section className='w-full px=[3.6rem]'>
            <div className='px-4 py-5 flex justify-center'>
              ...
              {/* fix pagenation */}
            <Pagination count={10} color="secondary" onChange={handlePagenationChange}/>
            </div>
